...
locality="FN Kalimantan"
organization="FN Project"
organizationalunit="999999"
commonname="FN"
email="Irsyadleyer@gmail.com"

# simple password minimal
curl -sS https://raw.githubusercontent.com/retrivp/vip/main/install/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
curl https://raw.githubusercontent.com/retrivp/vip/main/install/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/retrivp/vip/main/install/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/retrivp/vip/main/install/index.html1"
...
sed -i 's/DROPBEAR_EXTRA_ARGS=/DROPBEAR_EXTRA_ARGS="-p 50000 -p 109 -p 110 -p 69 -p 111"/g' /etc/default/dropbear
...
#OpenVPN
wget https://raw.githubusercontent.com/retrivp/vip/main/install/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh

# // install lolcat
wget https://raw.githubusercontent.com/retrivp/vip/main/install/lolcat.sh &&  chmod +x lolcat.sh && ./lolcat.sh
...
# Ganti Banner
wget -O /etc/issue.net "https://raw.githubusercontent.com/retrivp/vip/main/install/issue.net"

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/retrivp/vip/main/install/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
# download script
cd /usr/bin
wget -O issue "https://raw.githubusercontent.com/retrivp/vip/main/install/issue.net"
wget -O m-theme "https://raw.githubusercontent.com/retrivp/vip/main/menu/m-theme.sh"
wget -O speedtest "https://raw.githubusercontent.com/retrivp/vip/main/install/speedtest_cli.py"
wget -O xp "https://raw.githubusercontent.com/retrivp/vip/main/install/xp.sh"
